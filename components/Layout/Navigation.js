  ...
  return (
    <div className="bg-white">
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-40 lg:hidden md:hidden" onClose={setOpen}>
          <Transition.Child
            as={Fragment}
                      ...
                      {menu?.data?.slices?.map((slice, idx) => {
                        return (
                          slice.variation == "dropdown" ?
                            <div key={idx} className="grid grid-cols-1 gap-y-10 gap-x-6">
                              <div>
                ...
                {menu?.data?.slices?.map((slice, idx) => {
                  return (
                    slice.variation == "default" && (
                      <div key={idx} className="space-y-6 border-t border-gray-200 py-6 px-4">
                        <div className="flow-root">
                          <PrismicLink
                            className="-m-2 block p-2 font-medium text-gray-900"
                            field={slice.primary.link}
                                ...
                                {({ open }) => (
                                  <>
                                    ...
                                    <Transition
                                      ...
                                      leaveTo="opacity-0"
                                    >
                                      <Popover.Panel className="absolute z-20 inset-x-0 top-full text-gray-500 sm:text-sm">
                                        <div
                                          className="absolute inset-0 top-1/2 bg-white"
                                          aria-hidden="true"
                                        />

                                        <div className="relative bg-white shadow ring-1 ring-black ring-opacity-5">
